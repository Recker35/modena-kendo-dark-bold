...
export default function IaidoHeroSection() {
  return (
    <section id="hero" className="relative mt-[72px] h-[620px] md:h-[680px] lg:h-[720px] flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 flex items-center justify-center bg-background">
        <img src={heroImg} alt="Iaido action" className="w-full h-full object-contain sm:object-cover" />
        <div className="absolute inset-x-0 bottom-0 h-1/2 bg-gradient-to-t from-black/70 to-transparent" />
      </div>

      <span className="kanji-watermark top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white">居合道</span>
