...
import HoverableTitleDivider from "@/components/HoverableTitleDivider";
      ...
      <main>
        <AnimatedSection className="section-padding pt-12 md:pt-16 pb-8 md:pb-12 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
              <HoverableTitleDivider title="MERCH MKC" className="mb-0" />
              <div className="inline-flex items-center border border-primary/50 bg-primary/10 px-4 py-2 w-fit md:self-start">
        ...
        <AnimatedSection className="section-padding pt-4 md:pt-6 pb-16 md:pb-20">
          <div className="max-w-7xl mx-auto border border-border bg-muted/40 p-8 md:p-10">
            <h2 className="heading-display text-2xl md:text-3xl text-foreground mb-3">COME ACQUISTARE</h2>
            <p className="text-muted-foreground leading-relaxed max-w-3xl">
              Se si fosse interessati all'acquisto, contattare telefonicamente Danilo Zaccarelli: 331 858 5877.
            </p>
          </div>
        </AnimatedSection>
      </main>
